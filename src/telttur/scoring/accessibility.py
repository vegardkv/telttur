...
Scores each lake by distance to the nearest drivable road and by the vertical
gain between the nearest road point and the lake.
"""
...
def score_accessibility(
    ...
    *,
    ...
    """Score each lake by distance to the nearest drivable road and by elevation gain.

    Added columns:
      road_distance_m  — metres to nearest drivable road (rounded to 1 dp)
      elevation_gain_m — |lake elev − road elev| in metres (rounded to 1 dp)
    """
